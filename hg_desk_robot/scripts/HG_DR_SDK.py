...
class HG_DR_SDK:
    ...
    # 初始化机械臂位姿
    def initializeSteppers(self, setX=259.48, setY=0.0, setZ=85.32): #259.48 0 85.32
        adjust = 0
        attempts = 10
    ...
    def move_to_angle(self, baseAngle, rearAngle, fronAngle):
        ...
        current_x, current_y, current_z = self.Kinematics.coordinatesFromAngles(baseAngle, rearAngle, fronAngle)
        print("target xyz :", current_x, current_y, current_z)
